  ...
  <Edit>
    ...
    >
      <div className="flex flex-col md:flex-row gap-4 mb-2">
        <h3 className="min-w-32 text-sm font-semibold">customer details</h3>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-2">
        <h3 className="min-w-32 text-sm font-semibold">customer address</h3>
        <div className="border rounded-sm p-4 bg-secondary flex-1 flex flex-col gap-4">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <h3 className="min-w-32 text-sm font-semibold">customer segment</h3>
        <div className="border rounded-sm p-4 bg-secondary flex-1 flex flex-col gap-4">
          ...
          <TextInput
            ...
            className="[&>input]:bg-white"
          />
          <AutocompleteArrayInput source="groups" />
        </div>
      </div>
    </SimpleForm>
  </Edit>
