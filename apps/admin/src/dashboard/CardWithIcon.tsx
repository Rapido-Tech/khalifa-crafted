...
export const CardWithIcon = ({ title, subtitle, to, children }: Props) => (
  <Card className="min-h-[52px] flex flex-col flex-1 [&_a]:no-underline [&_a]:text-inherit -py-6 rounded-none">
